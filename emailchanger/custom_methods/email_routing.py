...
def get_sender_details():
    ...
    email_account = frappe.db.get_value("Email Account", {"default_outgoing": 1}, ["email_id", "name"], as_dict=True)

    # Default sender details
    sender_name = email_account.name
    sender_email = email_account.email_id
    # Role-based sender details
    if "Projects User" in user_roles:
        sender_name = "ERP Support"
        sender_email = "erpsupport@standardtouch.com"
